	...
	<div class="row">
    	<div class="col-md-4">    
        	<h5 class="mb-3">If Already Registered !! Login</h5>
       		<form role="form" id="stuLoginForm" method="post" action="addstudent.jsp">
         		<div class="form-group">
           			<i class="fas fa-envelope"></i><label for="stuLogEmail" class="pl-2 font-weight-bold">Email</label><input type="email" class="form-control" placeholder="Email" name="stuLogEmail" id="stuLogEmail" required>
           		</div>
           		<div class="form-group">
      	...
      	<div class="col-md-6 offset-md-1">
        	...
        	<form role="form" id="stuRegForm" method="post" action="AddStudentServlet" enctype="multipart/form-data">
				<div class="form-group">
				...
				<div class="form-group">
			    	...
			    	<input type="text" class="form-control" placeholder="Phone" name="stuphone" id="stuphone" pattern="^\d{10}$" required>
			   	</div>
			   	<div class="form-group">
				...
				<div class="form-group">
			    	...
			    	<input type="text" class="form-control" placeholder="Occupation" name="stuocc" id="stuocc" required>
			   	</div>
				<div class="form-group">
			    	<i class="fas fa-camera"></i>
			    	<label for="stuimg" class="pl-2 font-weight-bold">Photo</label>
			    	<input type="file" class="form-control" name="stuimg" id="stuimg" required>
			   	</div>
