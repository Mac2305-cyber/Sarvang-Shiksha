...
<%
	if(request.getParameter("searchsubmit")!=null){
        ...
        ResultSet r = con.createStatement().executeQuery("SELECT * FROM courseorder, student, course WHERE courseorder.stu_id = student.stu_id and courseorder.course_id = course.course_id and inst_id="+session.getAttribute("instid")+" and order_date BETWEEN '"+startdate+"' AND '"+enddate+"'");
		if(r.next()){
%>			
